...
export declare class EventBus extends EventEmitter {
    ...
    emitOrderCreated(data: OrderEvent): boolean;
    emitOrderFilled(data: OrderEvent): boolean;
    emitOrderPartiallyFilled(data: OrderEvent): boolean;
    emitOrderCancelled(data: OrderEvent): boolean;
    emitOrderRejected(data: OrderEvent): boolean;
    ...
    onOrderFilled(callback: (data: OrderEvent) => void): this;
